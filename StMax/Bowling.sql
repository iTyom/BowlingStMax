...
INSERT INTO `Horaire` (`ID_Horaire`, `Libelle_Horaire`, `Horaire_Debut`, `Horaire_Fin`, `ID_Tarif`, `ID_Jeux`) VALUES
(1, 'Semaine', '14', '23', '22', '1'),
(2, 'Dimanche vacances', '10', '23', '22', '1'),
(11, 'Samedi', '10:00', '01:00', '22', '1'),
(12, 'Dimanche', '10:00', '22:00', '22', '1'),
(13, 'Bowling standard', '10:00', '22:00', '22', '1'),
(14, 'Laser standard', '14:00', '20:00', '22', '2'),
(15, 'Bowling jours férié', '14:00', '20:00', '22', '1'),
(16, 'Semaine Vacances', '10:00', '00:00', '22', '1'),
(18, 'Samedi vacances', '10:00', '00:00', '22', '1');
...
INSERT INTO `Jeux` (`ID_Jeux`, `Nom_Jeux`) VALUES
(1, 'Bowling'),
(2, 'Laser Blast');
...
ALTER TABLE `Horaire`
  ...
  ADD KEY `FK_TarifHoraire` (`ID_Tarif`) USING BTREE,
  ADD KEY `FK_JeuxHoraire` (`ID_Jeux`) USING BTREE;
...
--
ALTER TABLE `Horaire`
  ADD CONSTRAINT `FK_TarifHoraire` FOREIGN KEY (`ID_Tarif`) REFERENCES `Tarif` (`ID_Tarif`),
  ADD CONSTRAINT `FK_JeuxHoraire` FOREIGN KEY (`ID_Jeux`) REFERENCES `Jeux` (`ID_Jeux`);
